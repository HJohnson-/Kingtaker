...
public class KingtakerMain {
    ...
    public static void main(String[] args) throws Exception {
        frmJoinRequest frmJoinRequest = new frmJoinRequest("gcasale", 3404, null);
...
//        BasicChessvar bc = new BasicChessvar(new GameController( new BasicBoard(), new BasicDecoder(), myState, GameMode.MULTIPLAYER_LOCAL));
//
//        ChessVariant v = VariantFactory.getInstance().getVariantByID(2);
